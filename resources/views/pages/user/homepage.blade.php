        ...
        <div class="col-12 mid-div d-flex flex-column align-items-center">
            <div class="col-10 mt-5 position-relative">
                <div class="img-cont d-flex justify-content-center">
                    ...
                    <form action="{{ route('UserHotelSearchRoute') }}" method="GET" class="container shadow-lg rounded-4 bg-white p-4 position-absolute top-100 start-50 translate-middle">
                        <div class="input-group">
                            <input type="text" class="form-control form-control border-0" placeholder="Search" name="search" value="{{ request()->get('search') }}" style="box-shadow: none; outline: none;">
                                    ...
                                    <div class="card col-12 border-0 shadow mb-4">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <h4 class="card-title bold" style="color: #0057AB">{{ $hotel->name }}</h4>
                                                    ...
                                                    <div class="row">
                                                        <text class="card-text">Features</text>
                                                    </div>
                                                    <!--BUTTON TAG CLOUDS-->
