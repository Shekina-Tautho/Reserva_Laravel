    ...
    <div class="row">
        ...
        <div class="container-fluid image-container">
            <div class="row justify-content-center">
                <div class="col-12 px-0">
                    <img src="/storage/images/hotelsPic.png" alt="Tourist Spot" class="img-fluid w-100 hotelsPic">
                </div>
        ...
        <div class="col-7">
            ...
            <div class="d-flex gap-2 mb-3">
                <img src="/storage/images/sort icon.png" alt="sort icon" class="sortIcon mt-1">
