...
<div class="container-fluid main-div">
    ...
    <div class="col-12 d-flex align-items-center flex-column">
        <div class="col-10 mt-3">
            <div class="base-container border-0 shadow p-5 mb-5">
                ...
                <div class="d-flex mt-2 align-items-center">
                    <i class="bi bi-geo-alt p-0 gray me-1" style="color: #0057AB"></i>
                    <span class="hotel-info">{{ $hotels->address->thoroughfare }}, {{ $hotels->address->locality }}, {{ $hotels->address->administrative_area }}, {{ $hotels->address->postal_code }}, {{ $hotels->address->country }}</span>
                </div>
                <div class="overview py-3 mt-3">
                    <p class="bold large mb-0" style="color: #0057AB">Overview</p>
                    <span class="description">{{ $hotels->overview }}</span>
                </div>
                <div class="overview py-2">
                    <p class="bold large mb-1" style="color: #0057AB">Rooms</p>
                    @foreach ($rooms as $room)
                        <div class="card border-0 shadow rounded-2 mb-2">
                            <div class="row"> 
                                <div class="col-4"> 
                                    <img src="{{ asset('/images/' . $room->hotel->image_path . '.png') }}" class="img-fluid rounded" alt="room image">
                                </div>
                                <div class="col-8">
                                    <div class="card-body">
                                        <h5 class="card-title bold mb-2" style="color: #0057AB">{{ $room->room_type }}</h5>
                                        <div class="row mb-2">
                                            <div class="col-lg-6 col-12">
                                                <i class="bi bi-person-fill" style="color: #0057AB"></i>
                                                <text class="card-text">{{ $room->capacity }}</text>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <i class="bi bi-moon-stars-fill" style="color: #0057AB"></i>
                                                <text class="card-text">{{ $room->no_of_beds }}</text>
                                            </div>
                                        </div>
                                        <!--BUTTON TAG CLOUDS-->
                                        @if(str_contains($room->amenities, 'Free Breakfast'))
                                        ...
                                        @endif
                                        @if(str_contains($room->amenities, 'Free WiFi'))
                                            <button type="button" class="btn btn-outline-secondary btn-sm mb-1" disabled>
                                        ...
                                        @endif
                                        @if(str_contains($room->amenities, 'Parking Space'))
                                            <button type="button" class="btn btn-outline-secondary btn-sm mb-1" disabled>
                                        ...
                                        @endif
                                        @if(str_contains($room->amenities, 'Private Balcony'))
                                            <button type="button" class="btn btn-outline-secondary btn-sm mb-1" disabled>
                                        ...
                                        @endif
                                        @if(str_contains($room->amenities, 'Restaurant'))
                                            <button type="button" class="btn btn-outline-secondary btn-sm mb-1" disabled>
                                        ...
                                        @endif
                                        @if(str_contains($room->amenities, 'Swimming Pool'))
                                            <button type="button" class="btn btn-outline-secondary btn-sm mb-1" disabled>
                                        ...
                                        <div class="row d-flex mt-2">
                                            <div class="col-lg-6 col-12">
                                                <p class="card-text" style="font-weight: bold; color: #0057AB">${{ number_format($room->room_rates, 2) }} per night</p>
                                            </div>
                                            <div class="col-lg-6 col-12 d-flex justify-content-end">
                                                <a class="btn btn-primary" href="{{ url('paymentdetails', $room->room_id) }}" role="button" style="background-color: #0057AB; border-color: #0057AB">Book Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
